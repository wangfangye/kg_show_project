...
from manageDomain.models import DomainModel,entityModel,relationModel,entityLabelModel
...
class EntityLabelAdmin(admin.ModelAdmin):
    list_display = ['domain_name', "entity_node_label"]
...
admin.site.register(entityLabelModel, EntityLabelAdmin)
